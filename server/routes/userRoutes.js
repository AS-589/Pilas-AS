...
const {registerUser, loginUser, getUser, getUsers, editUser, followUnfollowUser, changeUserAvatar} = require('../controllers/userController')
const {createPost, updatePost, deletePost, getPost, getPosts, getUserPosts, getUserBookmarks, createBookmark, likeDislikePost, getFollowingPosts, filterPosts} = require('../controllers/postControllers')
...
router.get('/posts/filter', authMiddleware, filterPosts);
